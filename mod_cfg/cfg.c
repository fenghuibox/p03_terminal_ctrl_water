...
u8 cfgNewSet( u8 eepNew )
{
    ...
    return _stAppConfig.flash_is_new = eepIsNew;
}
...
void configDef( void )
{
    ...
    _stAppConfig.open_sec = CONFIG_DEF_OPEN_SEC;
    _stAppConfig.close_sec  = CONFIG_DEF_CLOSE_SEC;
    ...
    _stAppConfig.work_state = CONFIG_DEF_WORK_STATE;
...
void configLoad( void )
{
    ...
    driFlashEepRead( cfgPageIdGet(), 0, pTemp, sizeof(ST_CONFIG)/4 + 1);
}
